...
public class AddPlayers2 extends AppCompatActivity {
    @Override
        ...
        startGameButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getFirstPlayerName.isEmpty() || getSecondPlayerName.isEmpty()) {
                    Toast.makeText(AddPlayers2.this, "Enter player names", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(AddPlayers2.this, fourOnFour.class);
