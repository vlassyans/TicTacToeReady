...
public class AddPlayers1 extends AppCompatActivity {
    @Override
        ...
        startGameButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (getFirstPlayerName.isEmpty() || getSecondPlayerName.isEmpty()) {
                    Toast.makeText(AddPlayers1.this, "Enter player names", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(AddPlayers1.this, MainActivity.class);
